    ...
    <div className="bg-gray-900 rounded-xl p-6 shadow-2xl border border-gray-800">
      ...
      <div className="flex justify-between mt-8">
        ...
        {activeStep < totalSteps ? (
          <button 
            onClick={handleNext}
            className="px-6 py-3 bg-gradient-to-r from-blue-500 to-cyan-400 text-white rounded-lg font-medium hover:from-blue-600 hover:to-cyan-500 transition duration-200"
          >
            Next Step
          </button>
        ) : (
          <button 
            className="px-6 py-3 bg-gradient-to-r from-green-500 to-emerald-400 text-white rounded-lg font-medium hover:from-green-600 hover:to-emerald-500 transition duration-200"
          >
            Create Presale
          </button>
        )}
